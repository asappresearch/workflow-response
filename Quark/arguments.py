...
def get_args():
    ...
    parser.add_argument(
        '--dataset', type=str, default='data/wc_seed_one_convo.json',
        help='json file containing data')

    parser.add_argument(
        '--dataset_type', type=str, default='a2',
        help='[b1, b2, a1, oracle, kb ...]')
    # parser.add_argument(
    ...
    parser.add_argument(
        '--reward_model_path', type=str, default="./save/evaluator_scorer/230707/roberta-base/evaluator-roberta-base-tf-lr1e-4-bs16-epoch10-ws0-gas1-1gpu/",
        help='saved reward model path to load from')
    ...
    # policy
    parser.add_argument(
        '--init-model', type=str, default='./save/dist_st/230626/distilgpt2/utt_prediction-distilgpt2-tf-lr5e-4-bs16-epoch10-ws0-gas1-1gpu/', help='language model used for policy.')
    parser.add_argument(
        '--ref-model', type=str, default='./save/dist_st/230626/distilgpt2/utt_prediction-distilgpt2-tf-lr5e-4-bs16-epoch10-ws0-gas1-1gpu/', help='language model used for reference policy.')
    
    parser.add_argument(
        '--response-length', type=int, default=32, help='number of tokens to generate for each prompt.')
    parser.add_argument(
