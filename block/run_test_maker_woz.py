...
#eval_model_path = "./save/evaluator_scorer/230707/roberta-base/evaluator-roberta-base-tf-lr1e-4-bs16-epoch20-ws0-gas1-1gpu/"
...
with open("eval.csv", "w") as fh:
    ...
    for i in range(LEN):
        ...
        row["keys"] = [ x.split("/")[5] if x!="true_response"  else x for x in keys ]
